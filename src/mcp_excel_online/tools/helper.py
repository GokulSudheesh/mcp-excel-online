...
async def get_drive_children(client: GraphServiceClient, url: str) -> DriveItemCollectionResponse | None:
    """GET any OneDrive /children endpoint and return a list of DriveItems."""
    request_info = RequestInformation(Method.GET, f"{_GRAPH_BASE}{url}", {})
    request_info.headers.try_add("Accept", "application/json")
    result = await client.request_adapter.send_async(request_info, DriveItemCollectionResponse, {})
    return result
